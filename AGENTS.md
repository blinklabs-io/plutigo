...
Current pattern (will change with Plan 2):
```go
// Current: bare errors
return nil, errors.New("out of budget")

// Future: typed errors (Plan 2)
return nil, &BudgetError{Code: ErrCodeBudgetExhausted, ...}
```
